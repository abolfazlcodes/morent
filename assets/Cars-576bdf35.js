...
`,y=n.input`
  ...
  height: 18px;
  border-radius: 1rem;
`;y.defaultProps={type:"checkbox"};function S({id:e,onClick:a,active:i}){const o=()=>{a(e)};return t.jsx(w,{onClick:o,children:t.jsx(y,{checked:i,id:e})})}const P=n.span`
  font-size: 1.2rem;
  font-weight: 600;
...
`;function u({filterField:e,options:a}){const[i,o]=m(),s=i.get(e),l=r=>{const d=s?s.split(","):[];if(d.includes(r)){const f=d.filter(b=>b!==r).join(",");i.set(e,f),o(i)}else{d.push(r);const c=d.join(",");i.set(e,c),o(i)}};return t.jsxs(V,{children:[t.jsx(P,{children:e}),a.map(r=>t.jsx(j,{type:"horizontal",label:r.label,children:t.jsx(S,{id:r.value,onClick:l,active:!!(s!=null&&s.includes(r.value))})},r.value))]})}const O=n.aside`
  ...
  ${e=>e.isOpen&&x`
    ...
    `}
`;function F({isOpen:e}){return t.jsxs(O,{isOpen:e,children:[t.jsx(u,{filterField:"Type",options:[{value:"Sport",label:"Sport"},{value:"SUV",label:"SUV"},{value:"MPV",label:"MPV"},{value:"Sedan",label:"Sedan"},{value:"Coupe",label:"Coupe"},{value:"Hatchback",label:"Hatchback"}]}),t.jsx(u,{filterField:"Capacity",options:[{value:"2",label:"2 People"},{value:"4",label:"4 People"},{value:"6",label:"6 People"},{value:"8",label:"8 People"}]})]})}function h(e,a){let i=[];return a&&e&&(i=e==null?void 0:e.filter(o=>a.values.some(s=>s.toLowerCase()===o[a.field].toString().toLowerCase()))),i}const z=n.section`
  display: grid;
...
`;function W(){const{isLoading:e,cars:a}=C(),[i]=m(),o=i.get("Type"),s=i.get("Capacity");if(e)return t.jsx(g,{});if(a&&(a==null?void 0:a.length)<1)return t.jsx(p,{resource:"cars"});let l;return o?l=h(a,{field:"category",values:o.split(",")}):s?l=h(a,{field:"capacity",values:s.split(",")}):l=a,l.length===0?t.jsx(p,{resource:"No car found"}):t.jsx(z,{children:l&&(l==null?void 0:l.map(r=>t.jsx(k,{type:"typeB",carData:r},r.id)))})}const E=n.div`
  display: grid;
